...
$ExecutionLogPath = "$env:round5\atomic-red-team\atomictest_auto.log"



Start-Transcript "$env:round5\Round5TestAuto.ps1.log"

$sleeptime = 10

$file = Get-Content $env:round5\atomic-red-team\round5test\Round5TestStep.ps1
