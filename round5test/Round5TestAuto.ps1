...
$ExecutionLogPath = "C:\r5\atomic-red-team\atomictest_auto.log"



Start-Transcript "C:\r5\Round5TestAuto.ps1.log"

$sleeptime = 10

$file = Get-Content C:\r5\atomic-red-team\round5test\Round5TestStep.ps1
